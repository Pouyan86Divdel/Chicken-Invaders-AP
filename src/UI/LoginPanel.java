...
public class LoginPanel extends JPanel {
    ...
    public LoginPanel(GameMain gameMain) {
        ...
        JLabel titleLabel = new JLabel("LOGIN TO GAME", SwingConstants.CENTER);
        ...
        JButton goToRegisterBtn = createStyledButton("Don't have an account? Register");
        gbc.gridx = 0; gbc.gridy = 4;
        gbc.insets = new Insets(8, 8, 8, 8);
        add(goToRegisterBtn, gbc);

        JButton backToMenuBtn = createStyledButton("Back to Main Menu");
